...
def caption_multi_line(xy, translations, caption, img, caption_font, caption_font_Chinese, rgb_color, xy_shift, isBbox=False, split_len=6):
    ...
    if int(len(split_lines) / split_len) == 0:
        if isBbox:
            ...
            draw.text((x1 + x1_shift, y1 + y1_shift - caption_font_Chinese.getsize(caption)[1] - caption_font.getsize(caption)[1]), caption, font=caption_font_Chinese, fill=text_color)
...
image_folder = '/data/xcao/code/multimodal_exp/video_out_jpg/tasks_coffee_shop/demo_video'
...
# Video file path
video_path = '/data/xcao/code/multimodal_exp/demo_video_output/output_video_caffe.mp4'
