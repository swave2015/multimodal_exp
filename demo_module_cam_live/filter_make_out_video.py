...
image_folder = '/data/xcao/code/multimodal_exp/video_out_jpg/Package_Delivery_Driver_Gone_Wrong_FAIL/demo_video'
...
if images:
    ...
    video = cv2.VideoWriter(video_path, fourcc, 25, (width, height))  # 30 is the fps (frames per second)
