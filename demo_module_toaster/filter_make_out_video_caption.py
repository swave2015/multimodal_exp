...
image_folder = '/data/xcao/code/multimodal_exp/video_out_jpg/tasks_toaster_caption/demo_video'
caption_font = ImageFont.truetype("/data/xcao/code/multimodal_exp/miscellaneous/fonts/Arial_Bold.ttf", 40)
# Video file path
video_path = '/data/xcao/code/multimodal_exp/demo_video_output/toaster_caption_black_subtitle_04.mp4'
rgb_color = (0, 0, 0)
frame_rate = 15
subtitles = []
        ...
        if os.path.exists(label_file_path):
            with open(label_file_path, 'r') as file:
                ...
                for line in lines:
                    ...
                    draw.text((100, height - 65), caption, font=caption_font, fill=rgb_color)
        #         for line in lines:
