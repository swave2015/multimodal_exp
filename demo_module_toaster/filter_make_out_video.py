...
image_folder = '/data/xcao/code/multimodal_exp/video_out_jpg/tasks_toaster/demo_video'
caption_font = ImageFont.truetype("/data/xcao/code/multimodal_exp/miscellaneous/fonts/Arial.ttf", 25)
# Video file path
video_path = '/data/xcao/code/multimodal_exp/demo_video_output/output_video_vqa.mp4'
